...
function isBaseMaterial(typeId: number): boolean {
  ...
  const oreIndicators = ['asteroid', 'ore', 'veldspar', 'scordite', 'pyroxeres', 'crokite', 'bistot', 'arkonor', 'omber', 'kernite', 'jaspet', 'hemorphite', 'hedbergite', 'gneiss', 'dark ochre', 'cobaltite', 'eratite', 'aordite', 'monazite', 'xenotime', 'mercoxit', 'copper', 'iron', 'silver', 'gold', 'aluminum', 'silicon', 'platinum', 'uranium', 'thorium', 'zydrine', 'megacyte', 'morphicite', 'nocticite', 'crystal', 'sheet', 'block', 'ingot', 'bar'];
